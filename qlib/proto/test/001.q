...
.qtx.testSuiter[`proto1;`repo`lib`file!`btick2`proto`001;"test proto"]
  ...
  .qtx.testCase[`proto2;"test proto"][
    .qtx.before[{
      ...
      .proto.odefine[`const;{[x] enlist[ 2;] 0f }]      
      .proto.nil;  
      a:{[x;y] y x } over enlist[ .proto.nil], .proto.adefine[;{(x;0f)}]@' `float`long`int`real;
      `a`o`g`f!enlist[a;o;{[x1;x2] ((x1*x2) + log x1) - sin x2};] {[x1;x2]((1 - x1) xexp 2) + 100*(x2 - x1*x1) xexp const 2}
      }]
    ...
    .qtx.shouldData[`6;"test .proto.proto";"%btick2%/qlib/proto/testData/proto2/6";{[a;o;f]
      df:.proto.proto[a;o;f];
      df[(1f;1 0f);(1f;0 1f)]
      }]
